  ...
  return (
    ...
    >
      <CheckboxPrimitive.Indicator
        ...
        className="grid scale-0 place-content-center text-current transition-transform duration-200 ease-out group-data-checked/checkbox:scale-100 group-data-indeterminate/checkbox:scale-100"
      >
        <svg
          viewBox="0 0 24 24"
          fill="none"
