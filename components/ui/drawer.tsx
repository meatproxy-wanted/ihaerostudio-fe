...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex shrink-0 flex-col gap-1 p-5 pb-0 group-data-[swipe-axis=y]/drawer-popup:text-center md:gap-2 md:text-left",
        className,
      )}
      {...props}
    />
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "mt-auto flex shrink-0 flex-col gap-2.5 p-5 pt-0",
        className,
      )}
      {...props}
    />
...
function DrawerTitle({ className, ...props }: DrawerPrimitive.Title.Props) {
  return (
    <DrawerPrimitive.Title
      ...
      className={cn(
        "font-heading text-md font-bold text-foreground",
        className,
      )}
      {...props}
    />
