...
function DropdownMenuCheckboxItem({
  ...
  return (
    ...
    >
      <span
        className="pointer-events-none absolute right-2 flex items-center justify-center text-primary-text"
